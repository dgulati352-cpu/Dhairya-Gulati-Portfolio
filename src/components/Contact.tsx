            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-5">
                <a 
                  ...
                  className="flex items-center gap-4 group transition-colors p-3.5 rounded-2xl bg-[#1c1c1c] border border-[#D4AF37]/30 text-stone-200 hover:border-[#D4AF37]"
                >
                ...
                <a 
                  ...
                  className="flex items-center gap-4 group transition-colors p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 hover:border-emerald-400"
                >
            ...
            <div className="mt-10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-3 rounded-2xl bg-[#1c1c1c] border border-[#D4AF37]/30 text-white hover:border-[#D4AF37] hover:bg-[#D4AF37]/20 transition-all duration-300 flex items-center justify-center gap-2.5 group shadow-sm"
                  aria-label="LinkedIn Profile"
                  title="LinkedIn"
                >
                  <Linkedin className="w-4 h-4 text-[#D4AF37] group-hover:scale-110 transition-transform" />
                ...
                <a
                  ...
                  title="GitHub"
                >
                  <Github className="w-4 h-4 text-[#D4AF37] group-hover:scale-110 transition-transform" />
                ...
                <a
                  ...
                  title="Dribbble"
                >
                  <svg className="w-4 h-4 fill-current text-[#D4AF37] group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
