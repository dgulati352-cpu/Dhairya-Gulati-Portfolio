...
export default function Footer() {
  ...
  return (
    <footer className="relative py-14 px-6 border-t border-[#C15F3C]/20 bg-[#15130F]">
      <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-2">
          ...
          <p className="text-xs text-stone-500 font-medium max-w-xs mt-0.5">
        ...
        <div className="flex flex-col items-center md:items-end text-center md:text-right gap-4">
          <button
            ...
            className="px-4 py-2 rounded-full glass-card-terracotta border border-[#C15F3C]/30 text-[#E88D6A] text-xs font-bold uppercase tracking-wider hover:border-[#C15F3C] hover:text-white transition-all cursor-pointer group shadow-lg flex items-center gap-2"
